...
src/%.o: ../src/%.cpp
	...
	/usr/local/bin/g++ -pg -p -g -fopenmp -I/usr/local/include -I"/Users/kamal/Documents/my_programs/c_code/RNAGate_v17/include" -I"/Users/kamal/Documents/my_programs/c_code/RNAGate_v17/include/nupack" -I"/Users/kamal/Documents/my_programs/c_code/RNAGate_v17/include/ViennaRNA/include/ViennaRNA" -O3 -ftree-vectorize -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o"$@" "$<"
